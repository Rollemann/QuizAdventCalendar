...
/*0*/   {
            ...
            walls: [
                {
                    area: { x: 100, y: 450, width: 70, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 100, startY: 150, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 300, drawLine: true, move: true },
...
/*4*/   {
            grounds: [
                ...
                { // right
                    area: { x: 1220, y: 600, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 1220, y: 450, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 1220, y: 300, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
...
/*6*/   {
            grounds: [
                ...
                { // under Y
                    area: { x: 520, y: 480, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // lift right
                    area: { x: 670, y: 610, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 670, startY: 200, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 410, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*7*/   {
            grounds: [
                ...
                { // left
                    area: { x: 0, y: 180, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // - top
                    area: { x: 400, y: 230, width: 350, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | left
                    area: { x: 400, y: 250, width: 20, height: 440 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 400, startY: 150, velocityX: 0, velocityY: 0.5, rangeX: 0, rangeY: 100, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // | right
                    area: { x: 730, y: 250, width: 20, height: 440 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                ...
                { // - bottom
                    area: { x: 400, y: 690, width: 350, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // lift left
                    area: { x: 100, y: 500, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 100, startY: 200, velocityX: 0, velocityY: 0.7, rangeX: 0, rangeY: 410, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift middle
                    area: { x: 200, y: 350, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 200, startY: 350, velocityX: 0, velocityY: 1.1, rangeX: 0, rangeY: 260, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift right
                    area: { x: 300, y: 450, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 300, startY: 250, velocityX: 0, velocityY: 0.9, rangeX: 0, rangeY: 300, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*8*/   {
            grounds: [
                ...
                { // left
                    area: { x: 200, y: 480, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle top
                    area: { x: 420, y: 300, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle top
                    area: { x: 590, y: 300, width: 140, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle middle
                    area: { x: 420, y: 480, width: 70, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle middle
                    area: { x: 560, y: 480, width: 170, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // - left small
                    area: { x: 400, y: 580, width: 20, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                ...
                { // - left small
                    area: { x: 400, y: 380, width: 20, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                ...
                { // - bottom
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 400, startY: 250, velocityX: 0, velocityY: 0.5, rangeX: 0, rangeY: 440, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // - bottom small
                    area: { x: 650, y: 690, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // lift left
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 350, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 360, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*9*/   {
            grounds: [
                ...
                { // left
                    area: { x: 200, y: 280, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 120, y: 220, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 0, y: 180, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 1000, y: 550, width: 280, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // | right
                    area: { x: 730, y: 200, width: 20, height: 510 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // - top
                    area: { x: 420, y: 200, width: 310, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                ...
                { // - middle
                    area: { x: 420, y: 400, width: 310, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
...
/*13*/  {
            grounds: [
                ...
                {
                    area: { x: 370, y: 250, width: 30, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                {
                    area: { x: 370, y: 450, width: 30, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                {
                    area: { x: 160, y: 180, width: 140, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // - oben
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 420, startY: 200, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 200, drawLine: true, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // - unten
                ...
                { // lift
                    area: { x: 360, y: 200, width: 40, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 370, startY: 200, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 200, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift left
                    area: { x: 360, y: 500, width: 40, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 370, startY: 400, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 200, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift right
                    area: { x: 640, y: 400, width: 40, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 640, startY: 200, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 400, drawLine: true, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*14*/  {
            grounds: [
                ...
                { // in Y
                    area: { x: 370, y: 240, width: 280, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 0, y: 450, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 100, y: 180, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // | middle
                    area: { x: 500, y: 410, width: 20, height: 300 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 500, startY: 150, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 260, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // - behind
                    area: { x: 350, y: 390, width: 320, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 500, startY: 190, velocityX: 0, velocityY: 0.76923076923, rangeX: 0, rangeY: 200, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // - 
                ...
                { // | left
                    area: { x: 350, y: 210, width: 20, height: 180 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | right
                    area: { x: 650, y: 210, width: 20, height: 180 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // lift left
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 300, startY: 210, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 400, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift right
                    area: { x: 670, y: 210, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 670, startY: 210, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 400, drawLine: true, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*15*/  {
            grounds: [
                ...
                { // left C
                    area: { x: 420, y: 300, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle C
                    area: { x: 420, y: 420, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // middle C
                    area: { x: 580, y: 420, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // bottom C
                    area: { x: 420, y: 540, width: 280, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // |
                    area: { x: 400, y: 220, width: 20, height: 470 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 400, startY: 220, velocityX: 0.7, velocityY: 0, rangeX: 300, rangeY: 0, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*16*/  {
            grounds: [
                ...
                { // in H top
                    area: { x: 560, y: 300, width: 90, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // in H middle
                    area: { x: 420, y: 430, width: 110, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // in H middle
                    area: { x: 590, y: 430, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // in H bottom
                    area: { x: 420, y: 560, width: 70, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // in H bottom
                    area: { x: 550, y: 560, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 1000, y: 500, width: 140, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 800, y: 350, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 0, y: 570, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // -
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 420, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 440, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // | left
...
/*17*/  {
            grounds: [
                ...
                { // in R
                    area: { x: 420, y: 590, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // in R
                    area: { x: 420, y: 490, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 800, y: 600, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 900, y: 500, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 1000, y: 400, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 900, y: 300, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 800, y: 200, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 700, y: 100, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // | rechts mitte
                    area: { x: 550, y: 420, width: 20, height: 145 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | rechts unten
                    area: { x: 570, y: 545, width: 20, height: 165 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 570, startY: 400, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 145, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    area: { x: 350, y: 200, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
...
/*18*/  {
            grounds: [
                ...
                { // left
                    area: { x: 220, y: 590, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 220, y: 490, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 220, y: 390, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 820, y: 590, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 820, y: 490, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // right
                    area: { x: 820, y: 390, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // |
                    ...
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 300, startY: 310, velocityX: 2, velocityY: 0, rangeX: 600, rangeY: 0, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                }
            ]
...
/*19*/  {
            grounds: [
                ...
                { // left
                    area: { x: 230, y: 600, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 350, y: 490, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                ...
                { // | left
                    ...
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 500, startY: 220, velocityX: 1, velocityY: 0, rangeX: 180, rangeY: 0, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // | right
                    ...
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 500, startY: 465, velocityX: 1, velocityY: 0, rangeX: 180, rangeY: 0, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    area: { x: 580, y: 200, width: 40, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 580, startY: 140, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 60, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // - Top
                ...
                { // lift
                    area: { x: 450, y: 400, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 450, startY: 200, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 245, drawLine: true, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*20*/  {
            grounds: [
                {
                    area: { x: 0, y: 700, width: ctx.canvas.width / 2 - 80, height: mainHeight },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                {
                    area: { x: 720, y: 700, width: ctx.canvas.width / 2 - 80, height: mainHeight },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 300, y: 550, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 150, y: 450, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 0, y: 350, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 110, y: 260, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // - 
                    area: { x: 425, y: 230, width: 420, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | 
                    area: { x: 625, y: 250, width: 20, height: 400 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: { startX: 500, startY: 220, velocityX: 1, velocityY: 0, rangeX: 180, rangeY: 0, drawLine: false, move: false },
                ...
                { // lift
                    area: { x: 780, y: 335, width: 60, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 780, startY: 335, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 270, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
...
/*21*/  {
            grounds: [
                ...
                { // left
                    area: { x: 220, y: 600, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 120, y: 475, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 220, y: 350, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 140, y: 230, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 0, y: 150, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // left
                    area: { x: 1000, y: 550, width: 120, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // - left
                    area: { x: 320, y: 350, width: 200, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // - 
                    area: { x: 540, y: 350, width: 200, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 540, startY: 350, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 345, drawLine: false, move: false },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // | left
                    area: { x: 300, y: 300, width: 20, height: 410 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | middle
                    area: { x: 520, y: 350, width: 20, height: 360 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // | right
                    area: { x: 740, y: 350, width: 20, height: 360 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalVSprite.png',
                    scale: 1,
                    moveProps: null,
...
/*24*/  {
            grounds: [
                ...
                { // 1
                    area: { x: 100, y: 550, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 1
                    area: { x: 100, y: 400, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 1
                    area: { x: 100, y: 250, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 2
                    area: { x: 300, y: 400, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 2
                    area: { x: 300, y: 250, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 3
                    area: { x: 500, y: 550, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 3
                    area: { x: 500, y: 400, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 3
                    area: { x: 500, y: 250, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 4
                    area: { x: 700, y: 550, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 4
                    area: { x: 700, y: 400, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 4
                    area: { x: 700, y: 250, width: 80, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 5
                    area: { x: 900, y: 550, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 5
                    area: { x: 900, y: 400, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
                ...
                { // 5
                    area: { x: 900, y: 250, width: 100, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/carpetSprite.png',
                    scale: 1,
                    moveProps: null,
            ...
            walls: [
                { // lift
                    area: { x: 50, y: 400, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 50, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 350, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 250, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 350, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    ...
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 450, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 350, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    area: { x: 650, y: 400, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 650, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 350, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
                { // lift
                    area: { x: 850, y: 400, width: 50, height: 20 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/metalHSprite.png',
                    scale: 1,
                    moveProps: { startX: 850, startY: 250, velocityX: 0, velocityY: 1, rangeX: 0, rangeY: 350, drawLine: true, move: true },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    imageWholeSize: { w: false, h: false }
                },
            ]
