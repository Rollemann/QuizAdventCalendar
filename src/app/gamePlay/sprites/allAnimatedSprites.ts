...
/*7*/   {
            lights: [
                ...
                { // snowflake1
                    ...
                    ctx: ctx,
                    imageSrc: './SpriteSheets/SnowFlake1.png',
                    scale: 1,
                    maxFrames: 1,
                    maxAnimations: 1,
                    frameRate: 1000,
                ...
                { // snowflake2
                    ...
                    ctx: ctx,
                    imageSrc: './SpriteSheets/SnowFlake2.png',
                    scale: 1,
                    maxFrames: 1,
                    maxAnimations: 1,
                    frameRate: 1000,
            ...
            keys: [
                {
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 780, startY: 180, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                }
            ],
            traps: [
                { // saw
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 330, startY: 50, velocityX: 0, velocityY: 8, rangeX: 0, rangeY: 450, drawLine: true, move: true }
                },
                { // on T
                    position: { x: 530, y: 202 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/candyBarTrap.png',
                    scale: 1,
                    maxFrames: 13,
            ...
            keys: [
                {
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 630, startY: 630, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                }
            ],
            traps: [
                { // saw right
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 540, startY: 600, velocityX: 1.7, velocityY: 0, rangeX: 160, rangeY: 0, drawLine: true, move: false }
                },
                { // saw right
                    position: { x: 540, y: 600 },
                    ctx: ctx,
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 540, startY: 600, velocityX: 1.7, velocityY: 0, rangeX: 160, rangeY: 0, drawLine: true, move: true }
                },
                { // saw left
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 100, startY: 560, velocityX: 1, velocityY: 0, rangeX: 160, rangeY: 0, drawLine: true, move: true }
                },
                { // saw left
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 100, startY: 435, velocityX: 1, velocityY: 0, rangeX: 160, rangeY: 0, drawLine: true, move: true }
                },
                { // saw left
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 100, startY: 310, velocityX: 1, velocityY: 0, rangeX: 160, rangeY: 0, drawLine: true, move: true }
                },
                { // right
                    position: { x: 1000, y: 530 },
                    ctx: ctx,
            ...
            keys: [
                {
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 680, startY: 330, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                }
            ],
            traps: [
                { // saw right
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 20, startY: 460, velocityX: 0, velocityY: 0, rangeX: 0, rangeY: 0, drawLine: false, move: true }
                },
                { // in A
            ...
            keys: [
                {
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 660, startY: 400, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                }
            ],
            traps: [
                { // saw in S
                    position: { x: 545, y: 330 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/sawSprite.png',
                    scale: 0.1,
                    maxFrames: 5,
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 545, startY: 330, velocityX: 0, velocityY: 0, rangeX: 0, rangeY: 0, drawLine: false, move: false }
                },
                { // saw right
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 720, startY: 500, velocityX: 6, velocityY: 0, rangeX: 520, rangeY: 0, drawLine: true, move: true }
                },
                { // saw right
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 720, startY: 500, velocityX: 5, velocityY: 0, rangeX: 520, rangeY: 0, drawLine: true, move: true }
                },
                { // on S
...
/*24*/  {
            lights: [
                ...
                { // saw
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 545, startY: 330, velocityX: 0, velocityY: 0, rangeX: 0, rangeY: 0, drawLine: false, move: true }
                },
                { // candy
            ...
            keys: [
                {
                    ...
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 530, startY: 350, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                }
            ],
            traps: [
                { // lever
                    ...
                    maxAnimations: 1,
                    frameRate: 200,
                    animationFrames: [{ x: 1, y: 0 },{ x: 0, y: 0 }],
                    repeatAnimation: true,
                    startStatic: false,
                    dayNumber: { isDisplayed: false, value: -1, color: "black", size: 0, yOffset: 0 },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                ...
                { // key
                    ...
                    repeatAnimation: true,
                    startStatic: false,
                    dayNumber: { isDisplayed: true, value: 25, color: "black", size: 16, yOffset: -100 },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 530, startY: 200, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                },
                { // key
                    ...
                    maxAnimations: 1,
                    frameRate: 5,
                    animationFrames: [{ x: 9, y: 0 }, { x: 8, y: 0 }, { x: 7, y: 0 }, { x: 6, y: 0 }, { x: 5, y: 0 }, { x: 4, y: 0 }, { x: 3, y: 0 }, { x: 2, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 0 }],
                    repeatAnimation: true,
                    startStatic: false,
                    dayNumber: { isDisplayed: true, value: 24, color: "black", size: 16, yOffset: -100 },
                    hitBoxOffset: { x: 0, y: 0, width: 0, height: 0 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: { startX: 530, startY: 500, velocityX: 0, velocityY: 0.2, rangeX: 0, rangeY: 10, drawLine: false, move: true }
                },
                { // treasure
                    position: { x: 707, y: 175 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/treasureSprite.png',
                    scale: 2,
                    maxFrames: 12,
                    ...
                    repeatAnimation: false,
                    startStatic: true,
                    dayNumber: { isDisplayed: true, value: 23, color: "black", size: 16, yOffset: 25 },
                    hitBoxOffset: { x: 0, y: 15, width: 0, height: 15 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: null
                },
                { // treasure
                    position: { x: 707, y: 325 },
                    ctx: ctx,
                    imageSrc: './SpriteSheets/treasureSprite.png',
                    scale: 2,
                    maxFrames: 12,
                    ...
                    repeatAnimation: false,
                    startStatic: true,
                    dayNumber: { isDisplayed: true, value: 24, color: "black", size: 16, yOffset: 25 },
                    hitBoxOffset: { x: 0, y: 15, width: 0, height: 15 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: null
                },
                { // door
                    ...
                    repeatAnimation: false,
                    startStatic: true,
                    dayNumber: { isDisplayed: true, value: 0, color: "white", size: 16, yOffset: 45 },
                    hitBoxOffset: { x: 20, y: 30, width: 40, height: 60 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: null
                },
                { // door
                    ...
                    repeatAnimation: false,
                    startStatic: true,
                    dayNumber: { isDisplayed: true, value: 0, color: "white", size: 19, yOffset: 45 },
                    hitBoxOffset: { x: 20, y: 30, width: 40, height: 60 },
                    staticFrame: { x: 0, y: 0 },
                    moveProps: null
                }
